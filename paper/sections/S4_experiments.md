...
Table 7: DMD training length (6a recipe, 4000 steps), 20 samples, per-view anchor, bf16, fake pixels excluded. Step 1600 reproduces the main student; steps 2400 and 3200 are over-sharpened with lower PSNR; step 4000 recovers teacher-level sharpness and improves LPIPS but loses 0.42 dB of PSNR.
